...
const COLORS = ["#C8102E", "#FFC72C", "#334155", "#EA580C", "#059669"];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="mt-4">
          <p className="text-xs uppercase tracking-[0.22em] text-[#C8102E] font-semibold">Admin</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <Card key={k} className="p-5">
            ...
            <p className="mt-2 font-heading text-4xl font-extrabold text-[#C8102E]">{v ?? 0}</p>
          </Card>
        ))}
      </div>
          ...
          <div style={{ height: 300 }}>
            <ResponsiveContainer>
              <BarChart data={pieData}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="value" fill="#C8102E" name={t(lang, "submitted")} />
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-3 justify-between items-center">
        ...
        <Button data-testid="add-student-btn" onClick={() => setDlg({})} className="bg-[#C8102E] hover:bg-[#A60D26] gap-2">
    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        ...
        <DialogFooter>
          ...
          <Button data-testid="stu-save" onClick={save} disabled={!name || !mn || !hr} className="bg-[#C8102E] hover:bg-[#A60D26]">{t(lang, "save")}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-3 justify-between items-center">
        ...
        <Button data-testid="add-teacher-btn" onClick={() => setDlg({})} className="bg-[#C8102E] hover:bg-[#A60D26] gap-2">
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        ...
        <DialogFooter>
          <Button variant="outline" onClick={onClose}>{t(lang, "cancel")}</Button>
          <Button data-testid="teacher-save" onClick={save} disabled={!name || !code} className="bg-[#C8102E] hover:bg-[#A60D26]">{t(lang, "save")}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
...
function ModulesTab() {
  ...
  return (
    <Card className="p-8 text-center">
      ...
      <Button data-testid="go-module-master" onClick={() => nav("/module-master")} className="mt-6 bg-[#C8102E] hover:bg-[#A60D26]">
