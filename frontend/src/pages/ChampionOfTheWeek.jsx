...
const RANK_STYLE = {
  ...
  3: { bg: "bg-[#B91C1C]", text: "text-white", label: "3rd" },
};
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="mt-4">
          <p className="text-xs uppercase tracking-[0.22em] text-[#B91C1C] font-semibold">02 · Weekly Highlights</p>
        ...
        {isAdmin && (
          <div className="mt-10 flex justify-end">
            <Button data-testid="cotw-save-btn" onClick={save} className="bg-[#B91C1C] hover:bg-[#7F1D1D] gap-2">
